//! 磁盘信息采集
//!
//! 解析 `df`、`/proc/diskstats`、`/sys/block` 获取分区容量、inode、I/O 统计及设备类型。

use std::fs;

/// 通过 `df -i` 获取指定挂载点的 inode 使用情况。
pub fn get_inode_info(mount: &str) -> (u64, u64, u64, f64) {
...
pub fn extract_block_dev(device: &str) -> String {
...
pub fn get_io_stats(block_dev: &str) -> (u64, u64, u64) {
...
pub fn get_disk_type(block_dev: &str) -> String {
